...
function About() {
  return (
    <div name="about" className='bg-[#ffffff] text-black'>
        ...
        <div className='max-w-[1000px] mx-auto flex flex-col justify-center w-full p-4'>
            {/* <div>
            <p className='text-2xl ml-8 font-bold inline border-b-4 border-pink-300 ease-in-out duration-500'>About me</p>
            </div> */}
            <div className='flex flex-col md:flex-row mt-16 min-h-[300px] justify-center items-center'>
